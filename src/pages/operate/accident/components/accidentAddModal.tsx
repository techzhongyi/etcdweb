...
const AccidentAddModal: React.FC<modalType<accidentItemType>> = (
  props: any,
) => {
  const [formObj] = ProForm.useForm();
  const { visible, isShowModal, onFinish, record, editId, op } = props;
  ...
  useEffect(() => {
    if (record) {
      setInitialValues({
        ...
        complete_time: moment(record.complete_time * 1000).format('YYYY-MM-DD'),
